...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_search) {//查找
            SearchDialog();
            return true;
        } else if (id == R.id.action_insert) {//新增垃圾
            InsertDialog();
            return true;
        }
    ...
    private void DeleteDialog(final String strId) {
        new AlertDialog.Builder(this).setTitle("删除垃圾").setMessage("是否真的删除垃圾?").setPositiveButton("确定", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
    ...
    //查找对话框
    private void SearchDialog1() {
        String s = e.getText().toString();
        RefreshWordItemFragment(s);
    }
